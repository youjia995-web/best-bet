...
class BeidanMatch(Base):
    __tablename__ = "beidan_matches"
    id = Column(Integer, primary_key=True, autoincrement=True)
    issue_num = Column(String(20))
    match_no = Column(String(10))
    league = Column(String(50))
    home_team = Column(String(100))
    away_team = Column(String(100))
    ...
    draw_odds = Column(Float)
    away_odds = Column(Float)
    beidan_home = Column(Float)
    beidan_draw = Column(Float)
    beidan_away = Column(Float)
    odds_time = Column(String(30))


class BeidanOddsChange(Base):
    __tablename__ = "beidan_odds_changes"
    id = Column(Integer, primary_key=True, autoincrement=True)
    time = Column(String(30))
    league = Column(String(50))
    home = Column(String(100))
...
class BeidanValueMatch(Base):
    __tablename__ = "beidan_value_matches"
    id = Column(Integer, primary_key=True, autoincrement=True)
    match_id = Column(Integer)
    capture_time = Column(String(20))
    created_date = Column(String(20))
...
class BeidanBacktest2x1(Base):
    __tablename__ = "beidan_backtest_2x1"
    id = Column(Integer, primary_key=True, autoincrement=True)
    created_at = Column(String(30))
    match1_no = Column(String(10))
    match1_league = Column(String(50))
...
class BeidanSingleBet(Base):
    __tablename__ = "beidan_single_bet"
    id = Column(Integer, primary_key=True, autoincrement=True)
    created_at = Column(String(30))
    match_no = Column(String(10))
    league = Column(String(50))
...
class BeidanFallBet(Base):
    __tablename__ = "beidan_fall_bet"
    id = Column(Integer, primary_key=True, autoincrement=True)
    created_at = Column(String(30))
    match_no = Column(String(10))
    league = Column(String(50))
...
class BeidanDrawBet(Base):
    __tablename__ = "beidan_draw_bet"
    id = Column(Integer, primary_key=True, autoincrement=True)
    created_at = Column(String(30))
    match_no = Column(String(10))
    league = Column(String(50))
